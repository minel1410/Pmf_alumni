...
import EventForm from '@/app/user/my-events/components/EventForm';
import EventList from '@/app/user/my-events/components/EventList';
  ...
  useEffect(() => {
      const fetchUserAndEvents = async () => {
          try {
              ...
              const eventsResponse = await axios.get(`${API_URL}/events/admin/events`, { withCredentials: true });
